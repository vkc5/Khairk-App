...
final class CaseService {
    ...
    func createCase(ngoId: String, newCase: NgoCase, completion: @escaping (Result<String, Error>) -> Void) {
        let ref = casesRef(ngoId: ngoId).document() // auto id
    ...
    func listenCases(ngoId: String, onChange: @escaping (Result<[NgoCase], Error>) -> Void) -> ListenerRegistration {
    ...
    func deleteCase(ngoId: String, caseId: String, completion: @escaping (Result<Void, Error>) -> Void) {
