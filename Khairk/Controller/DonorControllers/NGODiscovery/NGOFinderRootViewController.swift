//
//  NGOFinderRootViewController.swift
//  Khairk
//
...
class NGOFinderRootViewController: UIViewController {
    ...
    private func openRealProfile() {
        ...
        let profileVC = sb.instantiateViewController(withIdentifier: "NGOFinderViewController")
