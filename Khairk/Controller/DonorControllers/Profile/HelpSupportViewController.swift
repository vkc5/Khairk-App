...
class HelpSupportViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    private var faqPopularFiltered: [FAQItem] = []
    private var faqGeneralFiltered: [FAQItem] = []
    private var faqServicesFiltered: [FAQItem] = []
    ...
    private var faqPopular: [FAQItem] = [
        FAQItem(
    ...
    private var faqGeneral: [FAQItem] = [
        FAQItem(
    ...
    private var faqServices: [FAQItem] = [
        FAQItem(
