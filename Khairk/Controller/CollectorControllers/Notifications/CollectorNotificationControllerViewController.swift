//
//  CollectorNotificationControllerViewController.swift
//  Khairk
//
...
class CollectorNotificationControllerViewController: UIViewController , UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell=tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! CollectorNotificationControllerTableViewCell
    ...
    @IBAction func goToNotificationSettings(_ sender: Any) {
        ...
        let mapVC = storyboard.instantiateViewController(withIdentifier: "CollectorNotificatinSettingsVC")
